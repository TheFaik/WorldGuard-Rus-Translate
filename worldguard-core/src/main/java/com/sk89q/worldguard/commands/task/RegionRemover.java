            ...
            for (ProtectedRegion test : manager.getRegions().values()) {
                ...
                if (parent != null && parent.equals(region)) {
                    throw new CommandException(
                            "Регион '" + region.getId() + "' имеет дочерние регионы. Используйте -f для принудительного удаления дочерних регионов. " +
                                    "или -u, чтобы сбросить значение родительского региона для этих дочерних регионов.");
                }
            }
