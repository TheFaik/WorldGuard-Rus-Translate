...
public class DebuggingCommands {
    ...
    @Command(aliases = {"testbreak"}, usage = "[игрок]", desc = "Симулировать разрушение блока", min = 1, max = 1, flags = "ts")
    ...
    @Command(aliases = {"testplace"}, usage = "[игрок]", desc = "Симулировать установку блока", min = 1, max = 1, flags = "ts")
    @CommandPermissions("worldguard.debug.event")
    ...
    @Command(aliases = {"testinteract"}, usage = "[игрок]", desc = "Симулировать взаимодействие с блоком", min = 1, max = 1, flags = "ts")
    @CommandPermissions("worldguard.debug.event")
    ...
    @Command(aliases = {"testdamage"}, usage = "[игрок]", desc = "Симулировать нанесение урона сущности", min = 1, max = 1, flags = "ts")
    @CommandPermissions("worldguard.debug.event")
