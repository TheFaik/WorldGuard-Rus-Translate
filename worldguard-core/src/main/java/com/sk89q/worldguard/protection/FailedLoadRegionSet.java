...
public class FailedLoadRegionSet extends AbstractRegionSet {
    ...
    private final String denyMessage = "Данные региона для WorldGuard не удалось загрузить для этого мира, " +
            "поэтому все было защищено в качестве меры предосторожности. Пожалуйста, сообщите администратору сервера.";
