...
public class ProtectedCuboidRegion extends ProtectedRegion {
    ...
    public void setMinimumPoint(BlockVector3 position) {
        WorldGuard.logger.warning("Вызов ProtectedCuboidRegion#setMinimumPoint проигнорирован. Изменение регионов ведет к неопределенному поведению.");
    }
    ...
    public void setMaximumPoint(BlockVector3 position) {
        WorldGuard.logger.warning("Вызов ProtectedCuboidRegion#setMaximumPoint проигнорирован. Изменение регионов ведет к неопределенному поведению.");
    }
