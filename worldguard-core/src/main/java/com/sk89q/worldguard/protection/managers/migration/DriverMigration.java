...
public class DriverMigration extends AbstractMigration {
    ...
    private void write(String name, Set<ProtectedRegion> regions) throws MigrationException {
        log.info("Сохранение данных для '" + name + "' со новым драйвером...");
        ...
        try {
            ...
            throw new MigrationException("Не удалось сохранить данные регионов для '" + store.getName() + "' к новому драйверу", e);
        }
    }
