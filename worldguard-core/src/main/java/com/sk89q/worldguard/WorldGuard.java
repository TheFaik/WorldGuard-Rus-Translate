...
public final class WorldGuard {
    ...
    public void setup() {
        ...
        try {
            ...
            logger.log(Level.WARNING, "Не удалось инициализировать кэш профилей SQLite. Кэш только в памяти.");
    ...
    public void disable() {
        ...
        try {
            logger.log(Level.INFO, "Завершение работы исполнителя и отмена всех ожидающих задач...");
