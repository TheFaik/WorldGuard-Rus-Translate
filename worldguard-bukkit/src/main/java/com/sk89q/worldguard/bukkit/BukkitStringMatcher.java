    ...
    public World matchWorld(Actor sender, String filter) throws CommandException {
        ...
        if (filter.charAt(0) == '#') {
            ...
            if (filter.equalsIgnoreCase("#main")) {
                ...
                throw new CommandException("Мир Незера не найден.");
                ...
                throw new CommandException("Мир Края не найден.");
                ...
                throw new CommandException("Недопустимый идентификатор '" + filter + "'.");
            }
        }
        ...
        throw new CommandException("Мир с таким точным названием не найден.");
    }
    ...
    public Iterable<? extends LocalPlayer> matchPlayers(Actor source, String filter) throws CommandException {
        ...
        if (filter.charAt(0) == '#') {
            ...
            if (filter.equalsIgnoreCase("#world")) {
                ...
                throw new CommandException("Недопустимая группа '" + filter + "'.");
            }
        }
